        ...
        <div className="grid lg:grid-cols-2 gap-12">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-3 bg-gray-800/50 border border-gray-700 rounded-lg focus:outline-none focus:border-purple-500 text-gray-200"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 bg-gray-800/50 border border-gray-700 rounded-lg focus:outline-none focus:border-purple-500 text-gray-200 resize-none"
                />
              </div>
              ...
              <button
                ...
                className="w-full py-4 bg-gradient-to-r from-purple-600 to-pink-600 rounded-lg font-semibold flex items-center justify-center gap-2 hover:shadow-lg hover:shadow-purple-500/50 transition-all disabled:opacity-50"
              >
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-gray-400">
                I’m a fresher who enjoys learning new technologies and building simple,
                effective web applications. I’m open to opportunities, internships, and
                collaborations.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="flex gap-3">
                <a
                  ...
                  className="group w-10 h-10 flex items-center justify-center bg-purple-600/20 hover:bg-purple-600 rounded-lg transition-all hover:shadow-[0_0_20px_#a855f7]"
                >

        ...
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm">
              Building modern, high-performance web experiences through elegant design, clean
              code, and the latest architecture.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2 text-sm text-gray-400">
              <p>Email: infantrichart06@gmail.com</p>
            ...
            <div className="flex gap-3 mt-4">
              {['GitHub', 'LinkedIn'].map((platform) => (
                <a
                  ...
                  href={
                    platform === 'GitHub'
                      ? 'https://github.com/Richard00726'
                      : 'https://linkedin.com/in/infant-richart-l-207'
                  }
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 flex items-center justify-center bg-purple-600/20 hover:bg-purple-600 rounded-lg transition-colors"
                >
